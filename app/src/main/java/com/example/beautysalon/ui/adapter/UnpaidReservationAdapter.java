 ...
 * @description
 */
public class UnpaidReservationAdapter extends BaseQuickAdapter<ReserveDao, BaseViewHolder> implements LoadMoreModule {
    private List<StylistDao> mStylistDaoList;
    private List<ReserveDao> mReserveDaoList;
    private TextView mRemainTime;
    private TextView mStatus;
    public UnpaidReservationAdapter(@Nullable List<ReserveDao> data, List<StylistDao> stylistDaoList) {
